...
$nbt_locations = $addon->get_setting('nbt_locations') != '' ? $addon->get_setting('nbt_locations') : 'all';
...
<div id="tab-conditional-logic" style="display: none;">
    ...
    <div class="field-wrap enabled-by-addon-enable-rules addon-field-grid" style="display: none;">
            ...
            <label for="nbt-locations"><?php echo esc_html__( 'Choose Locations', 'yith-woocommerce-product-add-ons' ); ?></label>

            <div class="nbt-locations-container" style="margin-bottom:20px">
            <?php
                $locations = get_locations();
               
               $locations = array_merge(['all' => 'All'], $locations);

				$nbt_location= array_key_exists($nbt_locations, $locations)? $nbt_locations : 'all';
                yith_plugin_fw_get_field(
                    array(
                        'id'      => 'nbt-locations',
                        'name'    => 'nbt_locations',
